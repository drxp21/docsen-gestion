...
const navLinks = [
    ...
    {
        href: 'praticiens.index',
        name: 'Praticiens',
        should_show: ['superadmin', 'admin'].includes(page.props.auth.user?.role)
...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <template v-for="n in navLinks">
                                    <NavLink v-if="n.should_show" :href="route(n.href)" :active="route().current(n.href)">
                                        {{ n.name }}
                                    </NavLink>
                                </template>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <template v-for="n in navLinks">
                            <ResponsiveNavLink v-if="n.should_show" :href="route(n.href)" :active="route().current(n.href)">
                                {{ n.name }}
                            </ResponsiveNavLink>
                        </template>
                    </div>
            ...
            <!-- Page Content -->
            <main class="bg-gray-200/50 dark:bg-gray-900 px-5 md:px-10 lg:px-32 py-8 min-h-screen">
                <slot />
            </main>
        </div>
    </div>
